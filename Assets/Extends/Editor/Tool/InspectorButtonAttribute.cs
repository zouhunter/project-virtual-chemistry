...
public class InspectorBtnAttribute : PropertyAttribute
{
    ...
    public InspectorBtnAttribute(string MethodName)
    {
...
#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(InspectorBtnAttribute))]
public class InspectorButtonPropertyDrawer : PropertyDrawer
{
    ...
    {
        InspectorBtnAttribute inspectorButtonAttribute = (InspectorBtnAttribute)attribute;
