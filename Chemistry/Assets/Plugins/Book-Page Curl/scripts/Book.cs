...
public class Book : MonoBehaviour {
    ...
    private RectTransformData clippingPanelData;
    private RectTransformData nextPageClipData;
    private RectTransformData shadowData;
    private RectTransformData shadowLTRData;
    private RectTransformData leftData;
    private RectTransformData leftNextData;
    private RectTransformData rightData;
    private RectTransformData rightNextData;
    #endregion
    ...
    public void ResetBook()
    {
        ...
        clippingPanelData.Get(ClippingPlane.rectTransform);
        nextPageClipData.Get(NextPageClip.rectTransform);
        shadowData.Get(Shadow.rectTransform);
        shadowLTRData.Get(ShadowLTR.rectTransform);
        leftData.Get(Left.rectTransform);
        leftNextData.Get(LeftNext.rectTransform);
        rightData.Get(Right.rectTransform);
        rightNextData.Get(RightNext.rectTransform);
        Left.gameObject.SetActive(false);
        Right.gameObject.SetActive(false);
    }
