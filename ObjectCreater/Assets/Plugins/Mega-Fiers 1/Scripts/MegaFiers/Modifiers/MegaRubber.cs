...
public class MegaRubber : MegaModifier
{
	...
	public override bool Prepare(MegaModContext mc)
	{
		if ( target )
		{
			//tm = transform.worldToLocalMatrix * target.localToWorldMatrix;
			//tm = transform.localToWorldMatrix * target.localToWorldMatrix;
			//tm = target.localToWorldMatrix * transform.worldToLocalMatrix;
