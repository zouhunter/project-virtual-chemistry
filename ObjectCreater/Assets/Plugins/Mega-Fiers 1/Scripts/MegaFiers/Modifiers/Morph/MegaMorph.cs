...
public class MegaMorph : MegaMorphBase
{
	...
	Vector3[]				dif;	// changed to public, check it doesnt break anything
	...
	public void ModifyCompressedMT(MegaModifiers mc, int tindex, int cores)
	{
		...
		//Debug.Log("start " + startvert + " end " + endvert);
		//startvert = setStart[tindex];
		//endvert = setEnd[tindex];
		//Debug.Log("start1 " + setStart[tindex] + " end1 " + setEnd[tindex]);
