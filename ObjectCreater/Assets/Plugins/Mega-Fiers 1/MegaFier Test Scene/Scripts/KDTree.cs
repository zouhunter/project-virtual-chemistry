...
public class KDTree
{
	...
	//	Change this value to 2 if you only need two-dimensional X,Y points. The search will be quicker in two dimensions.
	const int numDims = 3;
	...
	//	idea of how deep the tree is (and therefore how well the splitting heuristic is performing).
