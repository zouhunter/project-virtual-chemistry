#ifndef CFX_UNITY_STANDARD_CORE_INCLUDED
#define CFX_UNITY_STANDARD_CORE_INCLUDED
...
inline FragmentCommonData FragmentSetup (float4 i_tex, half3 i_eyeVec, half3 i_viewDirForParallax, half4 tangentToWorld[3], half3 i_posWorld)
{
	...
	half3 normalWorld = PerPixelWorldNormal(i_tex, tangentToWorld);
	half3 eye		  = NormalizePerPixelNormal(i_eyeVec);

    float d = dot( normalWorld, -eye );
...
#endif // CFX_UNITY_STANDARD_CORE_INCLUDED
